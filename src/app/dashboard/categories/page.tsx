...
export default function CategoriesPage() {
    ...
    const getMerchantsForCategory = React.useCallback((categoryName: string) => {
        return Array.from(new Set(mockTransactions.filter((t) => t.category === categoryName).map((t) => t.merchant)));
    }, []);
        ...
        <div className="p-6">
            <Card>
                <div className="flex items-center justify-between mb-6">
                    <div>
                        ...
                        <p className="text-gray-600 mt-2">
                            Manage your transaction categories. Edit or delete categories, and handle transactions when
                            deleting.
                        </p>
                    </div>
                ...
                <CategoryTable
                    ...
                    detailPanel={(row) => <CategoryDetailPanel merchants={getMerchantsForCategory(row.name)} />}
                />
            </Card>
            <CategoryModal
                ...
                onSave={addCategory}
                form={form}
                setForm={(value) => setForm(typeof value === "function" ? value(form) : value)}
                mode="add"
            />
            <CategoryModal
                ...
                {categoryToDelete && (
                    <div className="space-y-4">
                        <p>
                            ...
                            <span className="font-semibold">{categoryToDelete.name}</span>. This category has{" "}
                            {categoryToDelete.transactionCount} transactions assigned to it.
                        </p>
                        ...
                        <div className="space-y-2">
                            <div className="flex items-center">
                                ...
                                />
                                <label htmlFor="unassign" className="ml-3 block text-sm font-medium text-gray-700">
                            ...
                            <div className="flex items-center">
                                <input
                                    ...
                                    value="reassign"
                                    checked={selectedReplacementCategory !== ""}
                                    onChange={() => setSelectedReplacementCategory(TRANSACTION_CATEGORIES[0])}
                                    className="h-4 w-4 text-primary-600 focus:ring-primary-500 border-gray-300"
                                />
                                <label htmlFor="reassign" className="ml-3 block text-sm font-medium text-gray-700">
                            ...
                            {selectedReplacementCategory !== "" && (
                                <div className="ml-7 mt-2">
                                    <CustomSelect
                                        ...
                                        onChange={(value) =>
                                            setSelectedReplacementCategory(value as TransactionCategory)
                                        }
