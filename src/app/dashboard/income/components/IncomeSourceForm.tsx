 ...
 */
export function IncomeSourceForm({ isOpen, onClose, onSubmit, isSubmitting, editingSource }: IncomeSourceFormProps) {
    ...
    const {
        ...
        defaultValues: {
            ...
            endDate: editingSource?.endDate ? format(editingSource.endDate, "yyyy-MM-dd") : undefined,
    ...
    return (
        ...
        >
            ...
            <form id="income-source-form" onSubmit={handleSubmit(onSubmit)} className="space-y-4">
