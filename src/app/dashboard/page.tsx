            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <Card>
                    <div className="flex items-center justify-between">
                        <div>
                            <h3 className="text-base font-semibold text-secondary-600">Total Balance</h3>
                ...
                <Card>
                    <div className="flex items-center justify-between">
                        <div>
                            <h3 className="text-base font-semibold text-secondary-600">Monthly Income</h3>
                ...
                <Card>
                    <div className="flex items-center justify-between">
                        <div>
                            <h3 className="text-base font-semibold text-secondary-600">Monthly Expenses</h3>
