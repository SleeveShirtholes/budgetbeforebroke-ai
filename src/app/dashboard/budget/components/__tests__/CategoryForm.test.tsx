...
const mockAvailableCategories: BudgetCategoryName[] = ["Housing", "Food & Groceries", "Transportation"];
    ...
    it("shows error messages when form has errors", () => {
        render(
            <CategoryForm
                newCategory={{ name: "", amount: "" }}
                setNewCategory={mockSetNewCategory}
                formErrors={{ name: "Please select a category", amount: "Please enter an amount" }}
                setFormErrors={mockSetFormErrors}
                availableCategories={mockAvailableCategories}
                isEditing={false}
                onSave={mockOnSave}
