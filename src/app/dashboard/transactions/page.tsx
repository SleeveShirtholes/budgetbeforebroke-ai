...
export default function Transactions() {
    ...
    const handleCreateTransaction = (transaction: Omit<Transaction, "id" | "createdAt" | "updatedAt">) => {
    ...
    const handleUpdateCategory = (transactionId: string, newCategory: TransactionCategory) => {
        setTransactions(
            transactions.map((t) =>
                t.id === transactionId ? { ...t, category: newCategory, updatedAt: new Date().toISOString() } : t
            )
        );
    };
        ...
        },
        {
            ...
            accessor: (row: Record<string, unknown>) => {
                ...
                return (
                    <CustomSelect
                        value={category}
                        onChange={(value) => handleUpdateCategory(id, value as TransactionCategory)}
            ...
            <div className="p-4 space-y-4">
                <div className="grid grid-cols-3 gap-4">
                    ...
                    <div>
                        ...
                        <p className="font-medium">{transaction.merchantLocation || "N/A"}</p>
                    </div>
                </div>
            </div>
        );
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="bg-white rounded-xl shadow p-6 border border-secondary-100">
                    <div className="flex items-center justify-between">
                        <div>
                            <h3 className="text-base font-semibold text-secondary-600">Income</h3>
                        ...
                        <div className="p-3 bg-green-50 rounded-lg">
                            <ArrowTrendingUpIcon className="w-6 h-6 text-green-600" aria-hidden="true" />
                        </div>
                    </div>
                </div>
                <div className="bg-white rounded-xl shadow p-6 border border-secondary-100">
                    <div className="flex items-center justify-between">
                        <div>
                            <h3 className="text-base font-semibold text-secondary-600">Expenses</h3>
                        ...
                        <div className="p-3 bg-red-50 rounded-lg">
                            <ArrowTrendingDownIcon className="w-6 h-6 text-red-600" aria-hidden="true" />
                        </div>
                    </div>
                </div>
                <div className="bg-white rounded-xl shadow p-6 border border-secondary-100">
                    <div className="flex items-center justify-between">
                        <div>
                            <h3 className="text-base font-semibold text-secondary-600">Money Saved</h3>
                            <p
            ...
            <div className="bg-white rounded-xl shadow border border-secondary-100">
                <div className="p-6">
                    <div className="flex justify-between items-center mb-6">
                        <h2 className="text-xl font-semibold text-secondary-900">Transactions</h2>
                        <button
