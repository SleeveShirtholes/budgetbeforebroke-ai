...
jest.mock("@/components/Table/Table", () => {
    return function MockTable({ data, columns }: { data: Record<string, unknown>[]; columns: TableColumn[] }) {
        return (
...
jest.mock("@/components/Modal", () => {
    return function MockModal({ children, isOpen, onClose, footerButtons }: ModalProps) {
...
describe("Transactions Page", () => {
    ...
    it("displays correct insights", () => {
        ...
        const expensesCard = screen.getByText("Expenses").closest("div")?.parentElement;
        const savingsCard = screen.getByText("Net Savings").closest("div")?.parentElement;
