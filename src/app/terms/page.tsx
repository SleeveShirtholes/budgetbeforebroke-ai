            ...
            <div className="prose prose-secondary max-w-none">
              <section className="mb-8">
                ...
                <p className="text-secondary-700 mb-4">
                  By accessing and using Budget Before Broke, you accept and
              ...
              <section className="mb-8">
                ...
                <p className="text-secondary-700 mb-4">
                  Budget Before Broke is a personal financial management
                  platform that helps users track expenses, create budgets, and
                  achieve their financial goals. Our service includes:
                </p>
              ...
              <section className="mb-8">
                ...
                <ul className="list-disc pl-6 text-secondary-700 space-y-2">
                  ...
                  <li>
                    Interfering with the proper functioning of our service
                  </li>
              ...
              <section className="mb-8">
                ...
                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-4">
                  <p className="text-yellow-800 font-medium">
                    Important: Budget Before Broke is a financial management
                ...
                <ul className="list-disc pl-6 text-secondary-700 space-y-2">
                  ...
                  <li>
                    Our insights and recommendations are for informational
                    purposes only
                  </li>
                  <li>
                  ...
                  <li>
                    We are not responsible for financial decisions made based on
                    our platform
                  </li>
              ...
              <section className="mb-8">
                ...
                <ul className="list-disc pl-6 text-secondary-700 space-y-2">
                  ...
                  <li>
                    We recommend regularly reviewing your account information
                  </li>
                  ...
                  <li>
                    Always refer to your official bank statements for definitive
                    information
                  </li>
                </ul>
              </section>
              ...
              <section className="mb-8">
                ...
                <p className="text-secondary-700 mb-4">
                  The Budget Before Broke platform, including all content,
                ...
                <ul className="list-disc pl-6 text-secondary-700 space-y-2">
                  ...
                  <li>
                    You grant us license to use your data to provide our
                    services
                  </li>
                  <li>
              ...
              <section className="mb-8">
                ...
                <ul className="list-disc pl-6 text-secondary-700 space-y-2">
                  <li>
                    We provide our service &quot;as is&quot; without warranties
                  </li>
                  <li>
              ...
              <section className="mb-8">
                ...
                <p className="text-secondary-700 mb-4">
                  ...
                  immediately. You may delete your account at any time by
              ...
              <section className="mb-8">
                ...
                <p className="text-secondary-700 mb-4">
                  ...
                  our platform. Your continued use of the service constitutes
              ...
              <section className="mb-8">
                ...
                <p className="text-secondary-700 mb-4">
                  ...
                  the laws of [Your Jurisdiction], and you irrevocably submit to
