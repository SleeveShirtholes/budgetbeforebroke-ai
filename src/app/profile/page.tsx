...
export default function ProfilePage() {
    const { data: profileData, error, isLoading, mutate } = useSWR("/profile", fetchProfile);
        ...
        <div className="max-w-4xl mx-auto px-4 py-8 space-y-6">
            ...
            <div className="flex items-center justify-between">
                <ProfileHeader
                    ...
                    avatar={profileData?.image || session?.user?.image || "/default-avatar.png"}
                    onAvatarChange={() => {}}
                />
                <PageInfo
                        ...
                        <div className="text-sm text-secondary-700 space-y-4">
                            ...
                            <div>
                                ...
                                <ul className="list-disc list-inside space-y-1">
                                    <li>Click &quot;Edit&quot; to modify your name and phone number</li>
            ...
            <Card variant="default" padding="lg">
                ...
                <ProfileInformation
                    name={(profileData && profileData.name) || session?.user?.name || "User"}
                    email={(profileData && profileData.email) || session?.user?.email || "user@example.com"}
