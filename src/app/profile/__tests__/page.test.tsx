...
jest.mock("../components/ProfileInformation", () => {
    ...
    const ProfileInformation = (props: any) => (
        <div data-testid="profile-information">
            <div>{props.name}</div>
            <div>{props.email}</div>
            <input data-testid="phone-input" value={props.phoneNumber} disabled={!props.isEditing} />
            {props.isEditing && (
                <div>
...
describe("ProfilePage", () => {
    ...
    beforeEach(() => {
        ...
        (useSWR as jest.Mock).mockReturnValue({ data: { ...mockProfileData, avatar: testAvatar } });
