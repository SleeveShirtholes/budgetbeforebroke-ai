...
const profileSchema = z.object({
    ...
    phoneNumber: z.string().refine((val) => val === "" || isValidPhoneNumber(val, "US"), {
        message: "Please enter a valid US phone number (e.g., (801) 673-1947 or +1 801-673-1947)",
    }),
});
            ...
            {isEditing && (
                <div className="mt-6 flex flex-col items-end space-y-2">
                    <div className="flex space-x-3">
                        ...
                        <Button type="submit" variant="primary" disabled={isLoading || !isDirty || !isValid}>
