...
describe("ProfileInformation", () => {
    ...
    it("renders the component with all information in view mode", () => {
        ...
        expect(screen.getByDisplayValue(mockProps.preferredName)).toBeInTheDocument();
    ...
    it("renders the component in edit mode", () => {
        ...
        const preferredNameInput = screen.getByDisplayValue(editProps.tempPreferredName);
        const phoneNumberInput = screen.getByDisplayValue(editProps.tempPhoneNumber);
    ...
    it("handles input changes correctly", () => {
        ...
        const preferredNameInput = screen.getByPlaceholderText("Enter your preferred name");
