 ...
 */
export default function DeleteMethodModal({ method, isDeleting, onClose, onConfirm }: DeleteMethodModalProps) {
    return (
        <Modal isOpen={!!method} onClose={onClose} title="Remove Sign-in Method">
            <div className="space-y-4">
                <p>
                    Are you sure you want to remove {method?.provider} as a sign-in method? You won&apos;t be able to
                    sign in with this method anymore.
                </p>
