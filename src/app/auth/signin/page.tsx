...
export default function SignIn() {
    ...
    const [isLoading, setIsLoading] = useState<"google" | "email" | "passkey" | null>(null);
        ...
        <div className="flex min-h-screen items-center justify-center">
            <Card variant="default" padding="lg" className="w-[600px]">
                ...
                <div className="grid gap-4">
                    {canUsePasskey && (
                        <Button variant="outline" onClick={handlePasskeySignIn} fullWidth disabled={isLoading !== null}>
                            {isLoading === "passkey" ? (
                    ...
                    <Button variant="outline" onClick={handleGoogleSignIn} fullWidth disabled={isLoading !== null}>
                        {isLoading === "google" ? (
                            <div className="h-4 w-4 animate-spin rounded-full border-2 border-gray-300 border-t-gray-600" />
                        ) : (
                            <>
