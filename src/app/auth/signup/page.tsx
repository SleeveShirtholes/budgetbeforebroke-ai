...
function getPasswordStrength(password: string) {
    ...
    if (minLength && hasUpper && hasSpecial) return { level: "Strong", valid: true };
    if (minLength && (hasUpper || hasSpecial)) return { level: "Medium", valid: false };
        ...
        <div className="flex min-h-screen items-center justify-center">
            <Card variant="default" padding="lg" className="w-[600px]">
                ...
                <div className="grid gap-4">
                    ...
                    <Button variant="outline" onClick={handleGoogleSignUp} fullWidth disabled={isLoading !== null}>
                        {isLoading === "google" ? (
