...
describe("TextField", () => {
    ...
    it("displays helper text with correct styling", () => {
        render(<TextField label="Name" id="name" helperText="Enter your full name" />);
    ...
    it("renders with start adornment", () => {
        ...
        render(<TextField label="Amount" id="amount" startAdornment={startAdornment} />);
    ...
    it("renders with end adornment", () => {
        ...
        render(<TextField label="Weight" id="weight" endAdornment={endAdornment} />);
    ...
    it("handles fullWidth prop correctly", () => {
        const { container } = render(<TextField label="Name" id="name" fullWidth={false} />);
