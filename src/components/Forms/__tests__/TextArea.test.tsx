...
describe("TextArea", () => {
    ...
    it("handles text input changes", async () => {
        ...
        render(<TextArea label="Description" id="description" onChange={handleChange} />);
    ...
    it("displays helper text with correct styling", () => {
        render(<TextArea label="Description" id="description" helperText="Maximum 500 characters" />);
    ...
    it("applies custom className correctly", () => {
        render(<TextArea label="Description" id="description" className="custom-class" />);
    ...
    it("handles fullWidth prop correctly", () => {
        const { container } = render(<TextArea label="Description" id="description" fullWidth={false} />);
