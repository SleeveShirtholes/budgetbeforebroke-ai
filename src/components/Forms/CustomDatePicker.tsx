...
export default function CustomDatePicker({
    ...
    const [inputValue, setInputValue] = useState(selectedDate ? format(selectedDate, "MMM d, yyyy") : "");
    ...
    return (
        <div className={`${fullWidth ? "w-full" : ""}`}>
            <label id={`${id}-label`} htmlFor={id} className="block text-sm font-medium leading-6 text-gray-900">
                {label}
