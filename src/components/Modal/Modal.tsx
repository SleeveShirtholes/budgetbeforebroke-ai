...
export default function Modal({ isOpen, onClose, title, children, maxWidth = "lg", footerButtons }: ModalProps) {
    useEffect(() => {
            ...
            {isOpen && (
                <>
                    ...
                    <div className="fixed top-0 left-0 w-screen h-screen z-50 overflow-y-auto">
                        <div
                            className="flex min-h-[100vh] items-start justify-center p-4 pt-24"
                            onClick={(e) => {
                        ...
                        >
                            <motion.div
                                ...
                                className={`relative w-full ${maxWidthClasses[maxWidth]} bg-white rounded-xl shadow-lg ring-1 ring-black/5 overflow-hidden`}
                            >
                                {/* Header */}
                                ...
                                {footerButtons && (
                                    <div className="px-6 py-4 border-t border-gray-100 bg-white">
                                        <div className="flex justify-end space-x-3">{footerButtons}</div>
                                    </div>
                                )}
                            </motion.div>
                        </div>
