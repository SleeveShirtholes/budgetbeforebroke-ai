...
describe("Card Component", () => {
    ...
    it("renders with default props", () => {
        ...
        expect(card).toHaveClass("rounded-xl", "shadow", "bg-white", "border", "border-secondary-100", "p-6");
    });
    ...
    it("renders with outline variant", () => {
        ...
        expect(card).toHaveClass("bg-transparent", "border", "border-secondary-200");
    });
    ...
    it("renders with filled variant", () => {
        ...
        expect(card).toHaveClass("bg-secondary-50", "border", "border-secondary-100");
    });
    ...
    it("applies custom className", () => {
        const { container } = render(<Card className="custom-class">Custom Class</Card>);
        const card = container.firstChild as HTMLElement;
