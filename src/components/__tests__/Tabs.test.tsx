...
describe("Tabs", () => {
    ...
    it("renders all tab options", () => {
        ...
        mockOptions.forEach((option) => {
            expect(screen.getByRole("tab", { name: option.label })).toBeInTheDocument();
        });
    });
    ...
    it("applies custom className when provided", () => {
        ...
        render(<Tabs options={mockOptions} value="tab1" onChange={mockOnChange} className={customClass} />);
    ...
    it("handles keyboard navigation", () => {
        ...
        function TabsWrapper() {
            ...
            return <Tabs options={mockOptions} value={selected} onChange={setSelected} />;
        }
        render(<TabsWrapper />);
