...
jest.mock("next/image", () => ({
    __esModule: true,
    default: (props: Omit<ImageProps, "src"> & { src: string }) => <img {...props} />,
}));
...
describe("Header", () => {
    ...
    it("renders with default props", () => {
        ...
        expect(screen.getByAltText("User")).toHaveAttribute("src", "/default-avatar.png");
    });

    it("renders with custom props", () => {
        render(<Header userName={mockUserName} userAvatar={mockUserAvatar} />);
        expect(screen.getByText(mockUserName)).toBeInTheDocument();
        expect(screen.getByAltText(mockUserName)).toHaveAttribute("src", mockUserAvatar);
    });
    ...
    it("toggles navigation dropdown on click", () => {
        ...
        expect(screen.getByText("Get insights into your spending")).toBeInTheDocument();
    ...
    it("toggles user dropdown on click", () => {
        ...
        const userButton = screen.getByRole("button", { name: new RegExp(mockUserName) });
