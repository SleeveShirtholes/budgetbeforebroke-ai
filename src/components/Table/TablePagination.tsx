        ...
        <div className="flex justify-center items-center space-x-1">
            ...
            <button
                ...
                className={`px-3 py-2 rounded-md flex items-center ${
                    currentPage === 1 ? "text-gray-400 cursor-not-allowed" : "text-gray-700 hover:bg-secondary-50"
                }`}
            >
                ...
                typeof page === "number" ? (
                    <button
                        ...
                        className={`px-3 py-1 rounded-md ${
                            currentPage === page ? "bg-primary-600 text-white" : "text-gray-700 hover:bg-secondary-50"
                        }`}
                    >
                        {page}
                    </button>
