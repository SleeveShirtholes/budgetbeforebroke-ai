...
export default function ColumnFilter({
    ...
    return (
        <div className="relative inline-block" ref={filterRef} style={{ zIndex: isOpen ? 9999 : "auto" }}>
            <button
            ...
            {isOpen && (
                <div
                    ...
                    style={{
                        ...
                        zIndex: 9999,
                        width: "16rem",
                        top: filterRef.current ? filterRef.current.getBoundingClientRect().bottom + 4 : 0,
