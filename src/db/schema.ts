import { decimal, integer, pgTableCreator, text, timestamp, unique } from "drizzle-orm/pg-core";
...
export const budgets = pgTable(
    ...
    (table) => ({
        yearMonthUnique: unique().on(table.budgetAccountId, table.year, table.month),
    })
);
