...
const mockCreateDebt = debtActions.createDebt as jest.MockedFunction<
  typeof debtActions.createDebt
>;
const mockUpdateDebt = debtActions.updateDebt as jest.MockedFunction<
  typeof debtActions.updateDebt
>;
const mockDeleteDebt = debtActions.deleteDebt as jest.MockedFunction<
  typeof debtActions.deleteDebt
>;
const mockCreateDebtPayment =
  debtActions.createDebtPayment as jest.MockedFunction<
    typeof debtActions.createDebtPayment
  >;
...
describe("useDebts", () => {
  ...
  describe("addPayment", () => {
    it("should create a payment successfully", async () => {
      ...
      mockCreateDebtPayment.mockResolvedValue({
