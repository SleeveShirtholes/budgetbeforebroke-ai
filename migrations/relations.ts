...
import { monthlyDebtPlanning, debtAllocations, budgetAccount, user, budgetAccountMember, budget, budgetCategory, category, contactSubmission, account, debt, dismissedWarnings, goal, incomeSource, passkey, plaidItem, budgetAccountInvitation, plaidAccount, session, supportRequest, supportComment, transaction } from "./schema";

export const debtAllocationsRelations = relations(debtAllocations, ({one}) => ({
...
export const monthlyDebtPlanningRelations = relations(monthlyDebtPlanning, ({one, many}) => ({
...
export const budgetAccountMemberRelations = relations(budgetAccountMember, ({one}) => ({
	budgetAccount: one(budgetAccount, {
...
export const dismissedWarningsRelations = relations(dismissedWarnings, ({one}) => ({
	budgetAccount: one(budgetAccount, {
...
export const budgetAccountInvitationRelations = relations(budgetAccountInvitation, ({one}) => ({
	budgetAccount: one(budgetAccount, {
...
export const plaidAccountRelations = relations(plaidAccount, ({one, many}) => ({
