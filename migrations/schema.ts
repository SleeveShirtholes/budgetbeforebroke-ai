...
export const recurringTransaction = pgTable(
  ...
  (table) => [
    foreignKey({
      columns: [table.budgetAccountId],
      foreignColumns: [budgetAccount.id],
      name: "recurring_transaction_budget_account_id_budget_account_id_fk",
    }).onDelete("cascade"),
    foreignKey({
      columns: [table.categoryId],
      foreignColumns: [category.id],
      name: "recurring_transaction_category_id_category_id_fk",
    }).onDelete("cascade"),
    foreignKey({
      columns: [table.createdByUserId],
      foreignColumns: [user.id],
      name: "recurring_transaction_created_by_user_id_user_id_fk",
    }).onDelete("cascade"),
  ],
);
